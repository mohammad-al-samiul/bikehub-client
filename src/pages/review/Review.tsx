    ...
    >
      ...
      >
        ...
        <Flex gap={3} alignSelf={{ base: "center", md: "start" }} zIndex={99}>
          ...
          >
            <HiArrowLeft
              className={`cursor-pointer font-bold transform hover:scale-125 transition-transform ${
                activeSlideIndex === 0 ? "text-gray-500" : "text-green-500"
              }`}
              size={28}
            />
          </div>
          ...
          >
            <HiArrowRight
              className={`cursor-pointer font-bold transform hover:scale-125 transition-transform ${
                activeSlideIndex === reviews.length - 1
                  ? "text-gray-500"
                  : "text-green-500"
              }`}
              size={28}
